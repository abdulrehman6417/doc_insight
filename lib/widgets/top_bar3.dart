...
class TopBar3 extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<TopBar3> createState() => _TopBar3State();
...
class _TopBar3State extends State<TopBar3> {
    ...
    return Column(
      children: [
        Container(
          ...
          padding:
              const EdgeInsets.only(left: 20, top: 45, bottom: 15, right: 10),
          child: Column(
            ...
            children: [
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  if (!snapshot.hasData) {
                    return Center(
                      child: CircularProgressIndicator(color: color2DarkBlue),
                    );
