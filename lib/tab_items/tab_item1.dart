...
import 'package:doc_insight/widgets/history_tiles.dart';
...
class _TabItem1State extends State<TabItem1> {
        ...
        Column(
          children: [
            ...
            StreamBuilder<List<Map<String, dynamic>>>(
              stream: firestoreService.getSymptomCheckHistory(currentUserId),
